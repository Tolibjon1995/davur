...
import BelDrop from './dropdownlar/BelDrop';
import Drop from './dropdownlar/Drop';


const Header = (props) => {
    const [open, setOpen] = useState('Popover1')
    const [open2, setOpen2] = useState('Popover-1')
    const [show, setshow] = useState(false)
    const [shov, setshov] = useState(false)
    const target =()=> setshow(!show)
    const targed =()=> setshov(!shov)
    return (
                    ...
                    <nav className="navbar navbar-expand">
                        <div className="collapse navbar-collapse justify-content-between">
                            ...
                            <ul className="navbar-nav header-right">
                                ...
                                <li className="nav-item dropdown notification_dropdown">
                                <a className="nav-link bell bell-link primary"  onClick={ props.drop}>
                                ...
                                <li className="nav-item dropdown notification_dropdown">
                                    <a className="nav-link  ai-icon warning" id={open2} onClick={targed}>
                                ...
                                <Drop popover={open2} och={shov}/>
                                    
                                </li>
                                <li className="nav-item dropdown header-profile">
                                    <a className="nav-link user-left" id={open} onClick={target}>
                                        <div className="header-info">
                                            <span>Hello, <strong>Samuel</strong></span>
                                        </div>
                                        <img src="images/profile/pic1.jpg" width={20} alt />
                                    </a>
                                <BelDrop popover={open} och={show}/>
                                </li>
                            </ul>
                        </div>
                    </nav>
