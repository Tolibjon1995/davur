            ...
            <div className="row page-titles mx-0">
                ...
                <div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item"><a href="javascript:void(0)">Widget</a></li>
                        <li className="breadcrumb-item active"><a href="javascript:void(0)">Statistics</a></li>
                    </ol>
                </div>
            </div>
            <div className="row skroll">
                <div className="col-xl-4 col-lg-12">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div id="DZ_W_TimeLine" className="widget-timeline dz-scroll" style={{ height: 370 }}>
                ...
                <div className="col-xl-4 col-lg-12">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div id="DZ_W_TimeLine1" className="widget-timeline dz-scroll style-1" style={{ height: 370 }}>
                                <ul className="timeline">
                                    <li>
                                        <div className="timeline-badge primary" />
                                        <a className="timeline-panel text-muted" href="#">
                ...
                <div className="col-xl-4 col-lg-12">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div id="DZ_W_Todo1" className="widget-media dz-scroll" style={{ height: 370 }}>
                                <ul className="timeline">
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="dropdown">
                                                <button type="button" className="btn btn-primary light sharp" data-toggle="dropdown">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="dropdown">
                                                <button type="button" className="btn btn-info light sharp" data-toggle="dropdown">
                                                    <svg width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg>
                                                </button>
                                                <div className="dropdown-menu">
                                                    <a className="dropdown-item" href="#">Edit</a>
                ...
                <div className="col-xl-4 col-lg-12">
                    <div className="card border-0 pb-0">
                        ...
                        <div className="card-body">
                            <div id="DZ_W_Todo2" className="widget-media dz-scroll" style={{ height: 370 }}>
                                <ul className="timeline">
                                    <li>
                                        <div className="timeline-panel">
                                            <div className="media mr-2">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">Resport created successfully <span className="badge badge-warning">Warning</span></h5>
                                                <small className="d-block">29 July 2020 - 02:26 PM</small>
                                            </div>
                                            <div className="dropdown">
                                                <button type="button" className="btn btn-info light sharp" data-toggle="dropdown">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">Dr sultads Send you Photo <span className="badge light badge-danger">Danger</span></h5>
                                                <small className="d-block">29 July 2020 - 02:26 PM</small>
                                            </div>
                                            <div className="dropdown">
                                                <button type="button" className="btn btn-primary light sharp" data-toggle="dropdown">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">Resport created successfully <span className="badge light badge-success">Success</span></h5>
                                                <small className="d-block">29 July 2020 - 02:26 PM</small>
                                            </div>
                                            <div className="dropdown">
                                                <button type="button" className="btn btn-danger light sharp" data-toggle="dropdown">
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">Reminder : Treatment Time! <span className="badge light badge-success">Success</span></h5>
                                                <small className="d-block">29 July 2020 - 02:26 PM</small>
                                            </div>
                                            <div className="dropdown">
                                                <button type="button" className="btn btn-primary light sharp" data-toggle="dropdown">
                ...
                <div className="col-xl-4 col-lg-12">
                    <div className="card border-0 pb-0">
                        ...
                        <div className="card-body">
                            <div id="DZ_W_Todo3" className="widget-media dz-scroll" style={{ height: 370 }}>
                                <ul className="timeline">
                                    <li>
                                        <div className="timeline-panel">
                                            <div className="media mr-2">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">Alfie Mason <small className="text-muted">29 July 2020</small></h5>
                                                <p className="mb-1">I shared this on my fb wall a few months back..</p>
                                                <a href="#" className="btn btn-primary btn-xxs shadow">Reply</a>
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">Jacob Tucker <small className="text-muted">29 July 2020</small></h5>
                                                <p className="mb-1">I shared this on my fb wall a few months back..</p>
                                                <a href="#" className="btn btn-primary btn-xxs shadow">Reply</a>
                                                <a href="#" className="btn btn-outline-danger btn-xxs">Delete</a>
                                            </div>
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">Jack Ronan <small className="text-muted">29 July 2020</small></h5>
                                                <p className="mb-1">I shared this on my fb wall a few months back..</p>
                                                <a href="#" className="btn btn-primary btn-xxs shadow">Reply</a>
                                                <a href="#" className="btn btn-outline-danger btn-xxs">Delete</a>
                                            </div>
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">Noah Baldon <small className="text-muted">29 July 2020</small></h5>
                                                <p className="mb-1">I shared this on my fb wall a few months back..</p>
                                                <a href="#" className="btn btn-primary btn-xxs shadow">Reply</a>
                                                <a href="#" className="btn btn-outline-danger btn-xxs">Delete</a>
                                            </div>
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">Thomas Grady  <small className="text-muted">02:26 PM</small></h5>
                                                <p className="mb-1">I shared this on my fb wall a few months back..</p>
                                                <a href="#" className="btn btn-primary btn-xxs shadow">Reply</a>
                                                <a href="#" className="btn btn-outline-danger btn-xxs">Delete</a>
                                            </div>
                                    ...
                                    <li>
                                        <div className="timeline-panel">
                                            ...
                                            <div className="media-body">
                                                <h5 className="mb-1">Oscar Weston  <small className="text-muted">29 July 2020</small></h5>
                                                <p className="mb-1">I shared this on my fb wall a few months back..</p>
                                                <a href="#" className="btn btn-primary btn-xxs shadow">Reply</a>
                                                <a href="#" className="btn btn-outline-danger btn-xxs">Delete</a>
                                            </div>
                ...
                <div className="col-xl-4 col-lg-12">
                    <div className="card border-0 pb-0">
                        ...
                        <div className="card-body">
                            <div id="DZ_W_Todo4" className="widget-media dz-scroll" style={{ height: 370 }}>
                                <ul className="timeline">
                                    <li>
                                        <div className="timeline-panel">
                ...
                <div className="col-xl-12 col-lg-12 col-sm-12">
                    <div className="row">
                        <div className="col-xl-3 col-lg-6 col-sm-6">
                            <div className="widget-stat card bg-primary">
                                <div className="card-header border-0 pb-0">
                                    ...
                                    <h5 className="text-white mb-0"><i className="fa fa-caret-up" /> 422</h5>
                                </div>
                        ...
                        <div className="col-xl-3 col-lg-6 col-sm-6">
                            <div className="widget-stat card bg-warning" style={{ overflow: 'hidden' }}>
                        ...
                        <div className="col-xl-3 col-lg-6 col-sm-6">
                            <div className="widget-stat card bg-secondary">
                                ...
                                <div className="card-body p-0">
                                    <div className="px-4"><span className="bar1" data-peity="{ &quot;fill&quot;: [&quot;rgb(255, 255, 255)&quot;, &quot;rgb(255, 255, 255)&quot;]}">6,2,8,4,-3,8,1,-3,6,-5,9,2,-8,1,4,8,9,8,2,1</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-3 col-lg-6 col-sm-6">
                            <div className="widget-stat card bg-danger overflow-hidden">
                                ...
                                <div className="card-body p-0">
                                    <span className="peity-line-2" data-width="100%">7,6,8,7,3,8,3,3,6,5,9,2,8</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card overflow-hidden">
                        <div className="card-body">
                            <div className="text-center">
                                ...
                                <a className="btn btn-outline-primary btn-rounded mt-3 px-5" href="javascript:void()">Folllow</a>
                            </div>
                        </div>
                        <div className="card-footer pt-0 pb-0 text-center">
                            <div className="row">
                    ...
                    <div className="card active_users">
                        ...
                        <div className="card-body pt-0">
                            <div className="list-group-flush mt-4">
                                <div className="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 font-weight-semi-bold border-top-0" style={{ borderColor: 'rgba(255, 255, 255, 0.15)' }}>
                ...
                <div className="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
                    <div className="card text-white bg-primary">
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item d-flex justify-content-between"><span className="mb-0">Allergies :</span><strong>Penicilin, peanuts </strong></li>
                            <li className="list-group-item d-flex justify-content-between"><span className="mb-0">Pressure :</span><strong>120/100 mmHG</strong></li>
                            <li className="list-group-item d-flex justify-content-between"><span className="mb-0">Diseases :</span><strong>Diabetes</strong></li>
                            <li className="list-group-item d-flex justify-content-between"><span className="mb-0">Temperture :</span><strong>34 Degree</strong></li>
                        </ul>
                    </div>
                </div>
                <div className="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
                    <div className="card text-white bg-warning text-black">
                        <ul className="list-group list-group-flush">
                            ...
                            <li className="list-group-item d-flex justify-content-between"><span className="mb-0">Dr Theodore Handle :</span><strong>Dentist</strong></li>
                            <li className="list-group-item d-flex justify-content-between"><span className="mb-0">Dr Valentino Morose :</span><strong>Surgeon</strong></li>
                            <li className="list-group-item d-flex justify-content-between"><span className="mb-0">Dr Fleece Marigold :</span><strong>Clinical</strong></li>
                            <li className="list-group-item d-flex justify-content-between"><span className="mb-0">Dr Eric Widget :</span><strong>Cardiology</strong></li>
                        </ul>
                    </div>
                </div>
                <div className="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
                    <div className="card">
                        <div className="card-body text-center ai-icon  text-primary">
                            ...
                            <a href="javascript:void(0);" className="btn my-2 btn-primary btn-lg px-4"><i className="fa fa-usd" /> Earn Budges</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-6 col-lg-6 col-xxl-6 col-md-6">
                            <div className="card">
                                ...
                                <div className="card-body text-center">
                                    <div className="ico-sparkline">
                                        <div id="sparkline9" style={{ height: 80 }} />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="col-xl-4 col-lg-12 col-sm-12">
                    <div className="card overflow-hidden">
                        <div className="text-center p-5 overlay-box" style={{ backgroundImage: 'url(images/big/img5.jpg)' }}>
                            <img src="images/profile/profile.png" width={100} className="img-fluid rounded-circle" alt />
                        ...
                        <div className="card-body pb-0">
                            <div className="row">
                                ...
                                <div className="col text-right">
                                    <h5 className="text-white"><i className="fa fa-caret-up" /> 260</h5>
                                    <span className="text-white">+12.5(2.8%)</span>
                                </div>
                            </div>
                        </div>
                        <div className="chart-wrapper">
                            <canvas id="chart_widget_1" />
                        </div>
                    </div>
                </div>
                <div className="col-xl-6 col-lg-6 col-xxl-6 col-sm-6">
                            ...
                            <div className="row justify-content-between align-items-center">
                                ...
                                <div className="col-auto">
                                    <div className="chart-wrapper" style={{ height: 100 }}>
                                        <canvas id="chart_widget_7" style={{ minWidth: 300 }} />
                                    </div>
                                </div>
                            </div>
                        </div>
