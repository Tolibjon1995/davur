                        ...
                        <table id="example5" className="display mb-4 dataTablesCard" style={{ minWidth: 845 }}>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$164.52</td>
                                    <td><span className="btn btn-sm light btn-secondary fs-16">$34.41</span></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>$24.55</td>
                                    <td><span className="btn btn-sm light btn-secondary fs-16">$70.00</span></td>
                                    <td>
                                        <div className="dropdown ml-auto text-right">
                                            <div className="btn-link" data-toggle="dropdown">
                                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg>
                                ...
                                <tr>
                                    ...
                                    <td>$251.16</td>
                                    <td><span className="btn btn-sm light btn-secondary fs-16">$50.50</span></td>
                                    <td>
                                        <div className="dropdown ml-auto text-right">
                                            <div className="btn-link" data-toggle="dropdown">
                                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg>
