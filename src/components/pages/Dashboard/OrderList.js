            ...
            <div className="row">
                <div className="col-12">
                    <div className="table-responsive">
                        <table id="example5" className="display mb-4 dataTablesCard" style={{ minWidth: 845 }}>
                            <thead>
                                <tr>
                                    <th>Order ID</th>
                                    <th>Date</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$164.52</td>
                                    <td><span className="btn btn-sm light btn-warning fs-16">New Order</span></td>
                                    <td>
                                        <div className="dropdown ml-auto text-right">
                                            ...
                                            <div className="dropdown-menu dropdown-menu-right">
                                                <a className="dropdown-item" href="#"><i className="las la-check-square scale5 text-primary mr-2" /> Accept Order</a>
                                                <a className="dropdown-item" href="#"><i className="las la-times-circle scale5 text-danger mr-2" /> Reject Order</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>$24.55</td>
                                    <td><span className="btn btn-sm light btn-primary">On Delivery</span></td>
                                    <td>
                                        <div className="dropdown ml-auto text-right">
                                            <div className="btn-link" data-toggle="dropdown">
                                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg>
                                ...
                                <tr>
                                    ...
                                    <td>$251.16</td>
                                    <td><span className="btn btn-sm light btn-success">Delivered</span></td>
                                    <td>
                                        <div className="dropdown ml-auto text-right">
                                            <div className="btn-link" data-toggle="dropdown">
                                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg>
                                ...
                                <tr>
                                    ...
                                    <td>$24.17</td>
                                    <td><span className="btn btn-sm light btn-warning">New Order</span></td>
                                    <td>
                                        <div className="dropdown ml-auto text-right">
                                            <div className="btn-link" data-toggle="dropdown">
                                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg>
