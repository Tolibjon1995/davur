          ...
          <div className="card">
            ...
            <div className="card-body orders-summary">
              <div className="d-flex order-manage p-3 align-items-center mb-4">
                ...
                <h4 className="mb-0">New Orders <i className="fa fa-circle text-success ml-1 fs-15" /></h4>
                <a href="javascript:void(0);" className="ml-auto text-primary font-w500">Manage orders <i className="ti-angle-right ml-1" /></a>
              </div>
              <div className="row">
                ...
                <div className="row align-items-center mx-0">
                  ...
                  <div className="col-xl-9 col-lg-8 col-xxl-8 col-sm-8 px-0">
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div className="progress mb-0" style={{height: 8, width: '100%'}}>
                        <div className="progress-bar bg-warning progress-animated" style={{width: '85%', height: 8}} role="progressbar">
                    ...
                    <div className="d-flex align-items-center  mb-3">
                      ...
                      <div className="progress mb-0" style={{height: 8, width: '100%'}}>
                        <div className="progress-bar bg-success progress-animated" style={{width: '70%', height: 8}} role="progressbar">
                          <span className="sr-only">60% Complete</span>
                        </div>
                      </div>
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="progress mb-0" style={{height: 8, width: '100%'}}>
                        <div className="progress-bar bg-dark progress-animated" style={{width: '30%', height: 8}} role="progressbar">
                          <span className="sr-only">60% Complete</span>
                        </div>
                      </div>
            ...
            <div className="card-body revenue-chart px-3">
              <div className="d-flex align-items-end pr-3 pull-right revenue-chart-bar">
                <div className="d-flex align-items-end mr-4">
                  <img src="images/svg/ic_stat2.svg" height={22} width={22} className="mr-2 mb-1" alt />
                  <div>
                ...
                <div className="d-flex align-items-end">
                  <img src="images/svg/ic_stat1.svg" height={22} width={22} className="mr-2 mb-1" alt />
                  <div>
