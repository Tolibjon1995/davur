            ...
            <div className="form-head d-flex mb-3 align-items-start">
                <div className="mr-auto d-none d-lg-block">
                    ...
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active"><a href="javascript:void(0)">Order Detaills</a></li>
                    </ol>
                </div>
                <div className="dropdown mb-md-3 mb-2 ml-auto">
                        ...
                        <div className="col-xl-12 col-lg-6 ">
                            <div className="card h-auto">
                                <div className="card-body text-center">
                                    <img src="images/avatar/1.jpg" width={150} className="rounded-circle mb-4" alt />
                                    <h4 className="mb-3 text-black font-w600">James Witwitcky</h4>
                                    <a href="#" className="btn btn-primary light btn-xs">Customer</a>
                                </div>
                                <div className="card bg-secondary sticky mb-0">
                                    ...
                                    <div className="card-body pt-3">
                                        <p className="fs-14 op7 text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                    </div>
                                    <div className="card-footer border-0 py-4 bg-warning rounded-xl">
                                        <div className="media align-items-center">
                                            <img className="mr-3 img-fluid rounded-circle" width={50} src="./images/delivery.png" alt="DexignZone" />
                                            <div className="media-body">
                                                <h5 className="my-0 text-white">6 The Avenue, <br />London EC50 4GN</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="table-responsive ">
                                        <table className="table items-table">
                                            <tbody><tr>
                                                ...
                                                <th className="my-0 text-black font-w500 fs-20">Total Price</th>
                                                <th />
                                            </tr>
                                                <tr>
                                                    <td>
                                                        <div className="media">
                                                            <img className="mr-3 img-fluid rounded" width={85} src="./images/avatar/1.jpg" alt="DexignZone" />
                                                            <div className="media-body">
                                                                <small className="mt-0 mb-1 text-primary font-w500">MAIN COURSE</small>
                                                                <h5 className="mt-0 mb-2 text-black mb-4">Chicken curry special with cucumber</h5>
                                                    ...
                                                    <td>
                                                        <a href="#" className="ti-close fs-28 text-danger las la-times-circle" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div className="media">
                                                            <img className="mr-3 img-fluid rounded" width={85} src="./images/avatar/2.jpg" alt="DexignZone" />
                                                            <div className="media-body">
                                                                <small className="mt-0 mb-1 text-primary font-w500">MAIN COURSE</small>
                                                                <h5 className="mt-0 mb-2 text-black mb-4">Italiano pizza with garlic</h5>
                                                                <div className="star-review fs-14">
                                                                    <i className="fa fa-star text-orange" />
                                                                    <i className="fa fa-star text-orange" />
                                                                    <i className="fa fa-star text-orange" />
                                                ...
                                                <tr>
                                                    <td>
                                                        <div className="media">
                                                            <img className="mr-3 img-fluid rounded" width={85} src="./images/avatar/3.jpg" alt="DexignZone" />
                                                            <div className="media-body">
                                                                <small className="mt-0 mb-1 text-primary font-w500">MAIN COURSE</small>
                                                                <h5 className="mt-0 mb-2 text-black mb-4">Watermelon juice with ice</h5>
                                                                <div className="star-review fs-14">
                                                                    <i className="fa fa-star text-orange" />
                                                                    <i className="fa fa-star text-orange" />
                                                                    <i className="fa fa-star text-orange" />
                                                    ...
                                                    <td>
                                                        <h4 className="my-0 text-secondary font-w600">2x</h4>
                                                    </td>
                                                    <td>
                            ...
                            <div className="card">
                                <div className="card-body">
                                    <div className="full-map-area mb-4">
                                        ...
                                        <a href="javascript:void(0);" className="btn btn-danger btn-xs">View in Fullscreen</a>
                                        <i className="flaticon-381-location-4" />
                                    </div>
                                    <div className="row mx-0">
                                        <div className="media align-items-center col-md-4 col-lg-6 px-0 mb-3 mb-md-0">
                                            <img className="mr-3 img-fluid rounded-circle" width={65} src="./images/avatar/3.jpg" alt="DexignZone" />
                                            <div className="media-body">
