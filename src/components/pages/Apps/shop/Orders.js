            ...
            <div className="row page-titles mx-0">
                ...
                <div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active"><a href="javascript:void(0)">Product Order</a></li>
                    </ol>
                </div>
            </div>
            <div className="row">
                                ...
                                <table className="table table-sm mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th className="align-middle" style={{ minWidth: '12.5rem' }}>Ship To</th>
                                    ...
                                    <tbody id="orders">
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">Ricky Antony, 2392 Main Avenue, Penasauka, New Jersey 02149
                                                <p className="mb-0 text-500">Via Flat Rate</p>
                                            </td>
                                            <td className="py-2 text-right"><span className="badge badge-success">Completed<span className="ml-1 fa fa-check" /></span>
                                            </td>
                                            <td className="py-2 text-right">$99
                                            </td>
                                            <td className="py-2 text-right">
                                                <div className="dropdown text-sans-serif"><button className="btn btn-primary tp-btn-light sharp" type="button" id="order-dropdown-0" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg></span></button>
                                                    <div className="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="order-dropdown-0">
                                                        <div className="py-2"><a className="dropdown-item" href="#!">Completed</a><a className="dropdown-item" href="#!">Processing</a><a className="dropdown-item" href="#!">On Hold</a><a className="dropdown-item" href="#!">Pending</a>
                                                            <div className="dropdown-divider" /><a className="dropdown-item text-danger" href="#!">Delete</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">20/04/2020</td>
                                            <td className="py-2">Kin Rossow, 1 Hollywood Blvd,Beverly Hills, California 90210
                                                <p className="mb-0 text-500">Via Free Shipping
                                                </p>
                                            </td>
                                            <td className="py-2 text-right"><span className="badge badge-primary">Processing<span className="ml-1 fa fa-redo" /></span>
                                            </td>
                                            <td className="py-2 text-right">$120
                                            </td>
                                            <td className="py-2 text-right">
                                                <div className="dropdown text-sans-serif"><button className="btn btn-primary tp-btn-light sharp" type="button" id="order-dropdown-0" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg></span></button>
                                                    <div className="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="order-dropdown-0">
                                        ...
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">Merry Diana, 1 Infinite Loop, Cupertino, California 90210
                                                <p className="mb-0 text-500">Via Link Road</p>
                                            </td>
                                            <td className="py-2 text-right"><span className="badge badge-secondary">On
                                                Hold<span className="ml-1 fa fa-ban" /></span>
                                            </td>
                                            <td className="py-2 text-right">$70
                                            </td>
                                            <td className="py-2 text-right">
                                                <div className="dropdown text-sans-serif"><button className="btn btn-primary tp-btn-light sharp" type="button" id="order-dropdown-0" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg></span></button>
                                                    <div className="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="order-dropdown-0">
                                        ...
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">30/04/2020</td>
                                            <td className="py-2">Bucky Robert, 1 Infinite Loop, Cupertino, California 90210
                                                <p className="mb-0 text-500">Via Free Shipping</p>
                                            </td>
                                            <td className="py-2 text-right"><span className="badge badge-warning">Pending<span className="ml-1 fas fa-stream" /></span>
                                            </td>
                                            <td className="py-2 text-right">$92
                                            </td>
                                            <td className="py-2 text-right">
                                                <div className="dropdown text-sans-serif"><button className="btn btn-primary tp-btn-light sharp" type="button" id="order-dropdown-0" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg></span></button>
                                                    <div className="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="order-dropdown-0">
                                        ...
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">30/04/2020</td>
                                            <td className="py-2">Rocky Zampa, 1 Infinite Loop, Cupertino, California 90210
                                        ...
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">30/04/2020</td>
                                            <td className="py-2">Ricky John, 1 Infinite Loop, Cupertino, California 90210
                                                <p className="mb-0 text-500">Via Free Shipping</p>
                                            </td>
                                            <td className="py-2 text-right"><span className="badge badge-primary">Processing<span className="ml-1 fa fa-redo" /></span>
                                            </td>
                                            <td className="py-2 text-right">$145
                                            </td>
                                            <td className="py-2 text-right">
                                                <div className="dropdown text-sans-serif"><button className="btn btn-primary tp-btn-light sharp" type="button" id="order-dropdown-0" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg></span></button>
                                                    <div className="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="order-dropdown-0">
                                        ...
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">30/04/2020</td>
                                            <td className="py-2">Cristofer Henric, 1 Infinite Loop, Cupertino, California 90210
                                                <p className="mb-0 text-500">Via Flat Rate
                                                </p>
                                            </td>
                                            <td className="py-2 text-right"><span className="badge badge-success">Completed<span className="ml-1 fa fa-check" /></span>
                                            </td>
                                            <td className="py-2 text-right">$55
                                            </td>
                                            <td className="py-2 text-right">
                                                <div className="dropdown text-sans-serif"><button className="btn btn-primary tp-btn-light sharp" type="button" id="order-dropdown-0" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg></span></button>
                                                    <div className="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="order-dropdown-0">
                                        ...
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">Brate Lee, 1 Infinite Loop, Cupertino, California 90210
                                                <p className="mb-0 text-500">Via Link Road</p>
                                            </td>
                                            <td className="py-2 text-right"><span className="badge badge-secondary">On
                                                Hold<span className="ml-1 fa fa-ban" /></span>
                                            </td>
                                            <td className="py-2 text-right">$90
                                            </td>
                                            <td className="py-2 text-right">
                                                <div className="dropdown text-sans-serif"><button className="btn btn-primary tp-btn-light sharp" type="button" id="order-dropdown-0" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg></span></button>
                                                    <div className="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="order-dropdown-0">
                                        ...
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">29/04/2020</td>
                                            <td className="py-2">Thomas Stephenson, 116 Ballifeary Road, Bamff
                                                <p className="mb-0 text-500">Via Flat Rate</p>
                                            </td>
                                            <td className="py-2 text-right"><span className="badge badge-primary">Processing<span className="ml-1 fa fa-redo" /></span>
                                            </td>
                                            <td className="py-2 text-right">$52
                                            </td>
                                            <td className="py-2 text-right">
                                                <div className="dropdown text-sans-serif"><button className="btn btn-primary tp-btn-light sharp" type="button" id="order-dropdown-0" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg></span></button>
                                                    <div className="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="order-dropdown-0">
                                        ...
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">29/04/2020</td>
                                            <td className="py-2">Evie Singh, 54 Castledore Road, Tunstead
                                                <p className="mb-0 text-500">Via Flat Rate</p>
                                            </td>
                                            <td className="py-2 text-right"><span className="badge badge-success">Completed<span className="ml-1 fa fa-check" /></span>
                                            </td>
                                        ...
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">29/04/2020</td>
                                            <td className="py-2">David Peters, Rhyd Y Groes, Rhosgoch, LL66 0AT
                                                <p className="mb-0 text-500">Via Link Road</p>
                                            </td>
                                            <td className="py-2 text-right"><span className="badge badge-success">Completed<span className="ml-1 fa fa-check" /></span>
                                            </td>
                                            <td className="py-2 text-right">$69
                                            </td>
                                            <td className="py-2 text-right">
                                                <div className="dropdown text-sans-serif"><button className="btn btn-primary tp-btn-light sharp" type="button" id="order-dropdown-0" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg></span></button>
                                                    <div className="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="order-dropdown-0">
                                        ...
                                        <tr className="btn-reveal-trigger">
                                            ...
                                            <td className="py-2">Jennifer Johnson, Rhyd Y Groes, Rhosgoch, LL66 0AT
                                                <p className="mb-0 text-500">Via Flat Rate</p>
                                            </td>
                                            <td className="py-2 text-right"><span className="badge badge-primary">Processing<span className="ml-1 fa fa-redo" /></span>
                                            </td>
                                            <td className="py-2 text-right">$112
                                            </td>
                                            <td className="py-2 text-right">
                                                <div className="dropdown text-sans-serif"><button className="btn btn-primary tp-btn-light sharp" type="button" id="order-dropdown-0" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span><svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd"><rect x={0} y={0} width={24} height={24} /><circle fill="#000000" cx={5} cy={12} r={2} /><circle fill="#000000" cx={12} cy={12} r={2} /><circle fill="#000000" cx={19} cy={12} r={2} /></g></svg></span></button>
                                                    <div className="dropdown-menu dropdown-menu-right border py-0" aria-labelledby="order-dropdown-0">
