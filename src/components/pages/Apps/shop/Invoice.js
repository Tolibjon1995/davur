            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="card mt-3">
                        <div className="card-header"> Invoice <strong>01/01/01/2018</strong> <span className="float-right">
                            ...
                            <div className="row mb-5">
                                ...
                                <div className="mt-4 col-xl-6 col-lg-6 col-md-12 col-sm-12 d-flex justify-content-lg-end justify-content-md-center justify-content-xs-start">
                                    <div className="row align-items-center" style={{ fontSize: '0.9rem' }}>
                                        <div className="col-auto"> <img src="https://apirone.com/static/promo/bitcoin_logo_vector.svg" className="img-fluid mb-3" style={{ maxHeight: 30 }} alt /><br />
                                        ...
                                        <div className="col-auto"> <img src="https://apirone.com/api/v1/qr?message=bitcoin%3A1DonateWffyhwAjskoEwXt83pHZxhLTr8H%3Famount%3D0.15050000" className="img-fluid" alt style={{ maxWidth: 114 }} /> </div>
                                    </div>
                                </div>
                            </div>
